...
public class AccountEventListener {
	...
	public void onApplicationEvent(AccountEvent accountEvent) {
		...
		log.info("Received Account From Account Event :"+accountEvent.getAccount().toString());
		 String routingKey = "account.created";
		    String message = "Account created with ID :"+ accountEvent.getAccount().getAccountNumber() +
		    		"and First Name :"+ accountEvent.getAccount().getFirstName() +
